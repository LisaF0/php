...
// • toutes les informations d'un film (titre, année, durée en HH:MM, genre, liste des
// acteurs (nom + prénom), réalisateur (nom + prénom))
// • la liste des acteurs ayant incarné un rôle précis (nom + prénom de l'acteur et
// film dans lequel le rôle a été incarné)
...
// REALISATEURS
$lucas = new Realisateur("LUCAS","Georges", "1944-05-14");
$peterjackson = new Realisateur("JACKSON","Peter",  "1961-10-31");
$spielberg = new Realisateur("SPIELBERG","Steven",  "1946-12-18");
$mendes = new Realisateur("MENDES","Sam","1965-08-01");
$campbell = new Realisateur("CAMPBELL", "Martin",  "1943-10-24");
$test = new Realisateur("MURMANN","Mickael","1985-01-17");
...
echo $lucas->getFilms();
echo $fantastique->getFilms();
echo $markhamill->getCasting();